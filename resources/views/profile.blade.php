...
<section class="d-flex justify-content-center justify-content-lg-between section-secArticle" style="margin-bottom: 3rem;">
    <div class="container-fluid text-md-start">
        <div class="row">
            <div class="col-md-1 col-lg-1 col-xl-1 article-img">
